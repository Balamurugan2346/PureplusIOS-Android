...
const VectorBg = ({bgColor = "black",iconTint="black",iconSize=25,icon,style}) => {
    return (
        <View style={[{ backgroundColor: bgColor, borderRadius: 10, width: 40, height: 40, alignItems: "center", justifyContent: "center" },style]}>
